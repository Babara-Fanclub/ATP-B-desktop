...
export const path_data = await read_path();

/** All the coordinates of the path.
 *
 * @type{[number, number]} */
const line_coords = path_data.features[1].geometry.coordinates;
/** All the coordinates where the robot will collect data.
 *
 * @type{[number, number]} */
const point_coords = path_data.features[0].geometry.coordinates;
